...
export default function Context() {
  return (
    <Section flow id="context" eyebrow="CONTEXT" eyebrowColor="text-tfam-gray">
      <Flow>
        <p className="font-satoshi text-[16px] text-ink leading-[23px]">
          ...
          polished, with strong branding and a clean interface, exactly like something made to show off the museum. I took it
          on as a solo redesign, from research through prototyping, to find out why so few people used it, and how to
          change that.
        </p>
      </Flow>

      <Flow className="mt-6 lg:mt-8 flex flex-col gap-2">
