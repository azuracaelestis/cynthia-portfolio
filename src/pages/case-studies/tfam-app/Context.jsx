  ...
  return (
    <Section id="context" eyebrow="CONTEXT">
      <p className="font-satoshi text-[16px] text-ink leading-[23px]">
        ...
        museum. I took this on as a solo redesign, owning the full process from research through prototyping, to
        understand why so few people actually used it, and how to change that.
      </p>
    </Section>
  );
}
